...
//   head: () => ({
//     meta: [
//       { title: "Contact Casmir Onyekani — Documentation Audit" },
//       {
//         name: "description",
//         content:
//           "Send Casmir Onyekani a link to your API repo or SDK docs for one specific, no-cost documentation gap review.",
//       },
//       { property: "og:title", content: "Contact Casmir Onyekani — Documentation Audit" },
//       {
//         property: "og:description",
//         content:
//           "Send a link to your API repo or SDK docs and get one specific documentation gap flagged.",
//       },
...
//             Have an API, SDK, or technical product that needs better documentation?
//           </h1>
//           <p className="mt-7 text-lg leading-8 text-mist">
//             Send me a link to your API repo or SDK docs and I’ll flag one specific documentation
//             gap. No cost. No obligation.
//           </p>
...
//                     ) : (
//                       <span className="size-4 text-center text-cobalt" aria-hidden="true">
//                         f
//                       </span>
//                     )}
//                     {label}
//                   </span>
//                   <span className="mono-type text-xs text-mist">URL not provided</span>
//                 </div>
//               ))}
//             </div>
//           </div>
...
//           >
//             <input type="hidden" name="form-name" value="documentation-audit" />
//             <p className="hidden">
//               <label>
...
//                 Start with the docs link.
//               </h2>
//               <p className="mt-3 text-sm leading-6 text-surface/60">
//                 A little context helps me understand where the reader is getting stuck.
//               </p>
//             </div>
...
//                   placeholder="Paste your API repo or SDK docs link, then tell me what you want developers to do."
//                 />
//               </div>
